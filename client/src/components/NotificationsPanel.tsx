    ...
    <div className="relative">
      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-80 bg-white rounded-2xl shadow-2xl border border-[oklch(0.92_0.02_85)] z-50 max-h-96 overflow-y-auto">
          {/* Header */}
          <div className="sticky top-0 bg-white rounded-t-2xl p-4 border-b border-[oklch(0.92_0.02_85)] flex items-center justify-between">
            <h3 className="font-bold text-[oklch(0.18_0.02_260)]">Notificações</h3>
            <div className="flex gap-2">
              {notifications.length > 0 && (
                <button
                  onClick={() => clearAll()}
                  className="text-xs text-[oklch(0.55_0.28_340)] hover:text-[oklch(0.38_0.22_262)] font-bold"
                >
                  Limpar tudo
                </button>
              )}
              <button
                ...
                className="p-1 hover:bg-[oklch(0.97_0.01_85)] rounded-lg transition-colors"
              >
